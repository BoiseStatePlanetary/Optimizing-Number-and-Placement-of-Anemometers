...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures and data/Martian_Windspeeds.jpg}
    \caption{}
    \label{fig:Martian_Windspeeds}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures and data/synthetic_martian_wind_profile.jpg}
    \caption{Same as Figure \ref{fig:synthetic_terrestrial_wind_profile} except for the wind speeds in Figure \ref{fig:Martian_Windspeeds}.}
    \label{fig:synthetic_martian_wind_profile}
\end{figure}
