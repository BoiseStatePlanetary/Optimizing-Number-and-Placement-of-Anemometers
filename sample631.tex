...
\begin{figure}
    ...
    \caption{Time-series of drone tilt angle in degrees (blue) and wind speed in ${\rm m\ s^{-1}}$ (orange dots). The wind speeds are recorded every 2 seconds (at 0.5 Hz), while the raw drone telemetry is recorded at 100 ms, shown as the light blue curve. The darker blue curve shows the tilt smoothed with a boxcar filter 1-second wide.}
